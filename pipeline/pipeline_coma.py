...
from pipeline.linkage_step import compute_page_linkage_probability, compute_page_linkage_probability_with_classifier, debug_linkage
...
"""
This step groups attributes based on Coma++ results
...
class PipelineComputeWeights(AbstractPipeline):
    ...
    def run(self, data):
        ...
        for cat, bdsa_data in data[0].items():
            result[cat] = self.source_attribute_clustering_coma(bdsa_data, cat)
    ...
    def source_attribute_clustering_coma(self, clustering_output: ClusteringOutput, cat: str):
        """
        Cluster attributes using Coma++
        ...
        self.compute_matches_with_coma(bdsa_data, clustering_output, cat)
    ...
    def do_record_linkage(self, bdsa_data, clustering_output, is_first_iteration, source2page_candidate_pairs):
        ...
        elif _config_.get_record_linkage_method() == _config_.RecordLinkageMethod.CLASS:
            page_edges = compute_page_linkage_probability_with_classifier(bdsa_data, clustering_output,
                                                                          is_first_iteration)
    ...
    def compute_matches_with_coma(self, bdsa_data:BdsaData, clustering_output:ClusteringOutput, cat:str):
        """
        Select candidate attribute pairs and launch Coma++
        :param bdsa_data: 
        :param clustering_output:
        :return: 
        """
        ...
        sa_edges.extend(self.get_matches(source_pair2sa_pair2nb_value_matches,
                                         clustering_output))
    ...
    def get_matches(self, source_pair2sa_pair2nb_value_matches,
